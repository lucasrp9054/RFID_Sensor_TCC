            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <form action="../php/primeiro_acesso/processar_dados_professor.php" method="POST">
                            ...
                            <div class="input-group custom">
                                <input type="text" name="senha" class="form-control form-control-lg" placeholder="Senha" required>
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="fa-solid fa-id-badge" aria-hidden="true"></i></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-0">
                                        <a class="btn btn-primary btn-lg btn-block">Salvar</a>
                                    </div>
                                </div>
                            </div>
                        </form>

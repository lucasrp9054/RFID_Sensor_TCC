...
<body>
            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="table-responsive">
                        <table id="alunosTable" class="table hover data-table-export">
                            <thead>
                                <tr>
                                    <th>MA</th>
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="table-responsive">
                        <table id="coordenadoresTable" class="table hover data-table-export nowrap">
                            <thead>
                                <tr>
                                    <th>MA</th>
                                    <?php if ($cod_categoria == 3): ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Opções para a tabela com botões de exportação

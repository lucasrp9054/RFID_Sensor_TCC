...
// Verifica se obter_dados retornou um usuário válido
						...
						<div class="col-md-12 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Grade Horária</li>
								</ol>
							</nav>
						</div>
					</div>
	...
	$(document).ready(function() {
		$('#calendar').fullCalendar({
			...
			events: {
				...
				method: 'POST',
				data: {
					ma_user: '<?php echo $_SESSION['ma_user']; ?>'
				},

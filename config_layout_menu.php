<div class="right-sidebar">
		<div class="sidebar-title">
			<h3 class="weight-600 font-16 text-blue">
				...
				<span class="btn-block font-weight-400 font-12">Interface do Usuário</span>
			</h3>
		...
		<div class="right-sidebar-body customscroll">
			<div class="right-sidebar-body-content">
				...
				<h4 class="weight-600 font-18 pb-10">Ícone de Menu Suspenso</h4>
				...
				<h4 class="weight-600 font-18 pb-10">Ícone de Lista de Menu</h4>
				...
				<div class="reset-options pt-30 text-center">
					<button class="btn btn-danger" id="reset-settings">Voltar ao Padrão</button>
				</div>
			</div>
		</div>
	</div>